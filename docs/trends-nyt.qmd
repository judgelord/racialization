...
nyt |> 
  ...
  aes(x = year, 
      ...
      color = president) +
  geom_point() +
  labs(title = paste0('Articles Mentioning a Federal Agency and "', term,'"'),
       y = "NYT Mentions",
       x = "",
       color = "") +
...
nyt_total |> 
  ...
  aes(x = year, 
      ...
      color = president) +
  geom_point() +
  labs(title = paste0('Share of Articles Mentioning a Federal Agency and "', term,'"'),
       y = "Share of NYT Articles",
       x = "",
       color = "") +
  geom_smooth(#method = "lm",
