...
# {background-image=figs/whitewash.jpg}
...
- How consistent is racialization of agencies in different contexts (e.g., the media, advocacy, and policymaking)? 
- How consistent is racialization over time?
- Do perceptions of racialization differ across agencies typically seen as either conservative or liberal?
...
# #knitr::include_graphics("docs/figs/trends-rules-term-36.png") # communities of color
