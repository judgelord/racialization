...
## Racializaton of Institutions {data-background-image="https://www.archpaper.com/wp-content/uploads/2024/07/2022-34_17_print.jpg" data-background-size="cover" data-background-opacity=".1"}
...
## Research Questions {data-background-image="https://ids.si.edu/ids/deliveryService?id=SAAM-2022.34_17&max=640" data-background-size="cover" data-background-opacity=".1"}
...
## {data-background-image="https://ids.si.edu/ids/deliveryService?id=SAAM-2022.34_21&max=640" data-background-size="cover" data-background-opacity=".1"}
...
- Perceived liberal-conservative leaning via expert surveys, appointments, donations, and voting patterns   <span style="font-style: italic; font-size: 12px; color: #333;">(Clinton and Lewis (2008); Richardson et al. (2019); Richardson et al. (2024); Epstein (1999); Nixon (2004); Chen and Johnson (2014); Maranto (2005); Maranto and Hult (2004); Bertelli and Grose (2011))</span>
...
<div style="border: 2px solid #2196F3; padding: 30px; margin-bottom: 30px; border-radius: 10px; font-size: 22px;">
- Racialized history shapes perceptions of agencies   <span style="font-style: italic; font-size: 12px; color: #333;">(King, 1999; Choi and Rainey, 2010; Schickler, 2016; Tate, 2003; White and Laird, 2020; Mansbridge, 1999; Watkins-Hayes, 2009; Minta, 2009; Juenke and Preuhs, 2012; Hayes and Hibbing, 2017)</span> 
...
- Racial attitudes & framing affect policy preferences <span style="font-style: italic; font-size: 12px; color: #333;">(Gilens, 1999; Kellstedt, 2003; Hutchings & Valentino, 2004; Bartels, 2020; Stephens-Dougan, L., 2020; O’Brian, 2024)</span>
...
## Data {data-background-image="https://ids.si.edu/ids/deliveryService?id=SAAM-2022.34_34&max=960" data-background-size="cover" data-background-opacity=".1"}
...
# Comparing across contexts {data-background-image="https://ids.si.edu/ids/deliveryService?id=SAAM-2022.34_34&max=960" data-background-size="cover" data-background-opacity=".1"}

$Racialization Score_{jk} = \frac{\sqrt{x_{ijk}} - \bar{x_{jk}}}{sd(x_{jk})}$

Where $x_{ijk}$ is the count of racialized terms in document/article/sentence $i$ about agency $j$ in source $k$. 

Thus, all scores are mean 0, standard deviation 1.
...
## Next Steps {data-background-image="https://ids.si.edu/ids/deliveryService?id=SAAM-2022.34_14&max=960" data-background-size="cover" data-background-opacity=".1"}
...
## Key Takeaways {data-background-image="https://ids.si.edu/ids/deliveryService?id=SAAM-2022.34_14&max=960" data-background-size="cover" data-background-opacity=".1"}
...
::: {.incremental}
 **Contact:**  
**kmagana@umich.edu** | **judgelor@umich.edu**  
:::
:::
:::
