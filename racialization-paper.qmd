...
```{r}
#| fig-cap: 'New York Times Articles Mentioning Racialized Terms By Agency, 2005-2025'
...
```{r}
#| fig-cap: 'New York Times Total Articles Mentioning a Federal Agency and Racialized Words 2005-2025'
...
#knitr::include_graphics("docs/figs/trends-rules-term-36.png") # communitis of color
knitr::include_graphics("docs/figs/trends-rules-term-55.png") # ethnic
knitr::include_graphics("docs/figs/trends-rules-term-49.png") # DEI
knitr::include_graphics("docs/figs/trends-rules-term-90.png") # minority pop
...
As with the NYT data, we aggregate all proposed and final rules from 2005 to 2025 to create two measures of racialization. The first measure is the count of proposed and final rules using one or more racialized words. 
...
We now turn to comparing racialization in the media, advocacy reports, and policy documents. Because each source includes data for a different set of agency, only agencies present in both datasets show up in the figures below.
...
Our racialization scores use the share of rules with racialized language, so they are not affected by overall volume. However, the low frequency of racialized rules in 2025 seen in the figures in @sec-rules are partially due to historic low levels of rulemaking in 2025. 
