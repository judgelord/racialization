...
In January 2025, the Trump Administration issued the "Ending Radical and Wasteful Government DEI Programs and Preferencing" executive order, initiating efforts to dismantle diversity, equity, inclusion, and accessibility (DEIA) in federal programs and practices. This executive order instructs agency heads to end efforts to reduce patterns of racial exclusion in the federal workforce. In tandem with this order, numerous federal employees whose jobs included attention to racial diversity, equity, or inclusion were targeted and abruptly dismissed. In parallel, significant budget cuts targeted programs and institutions researching racial inequalities and patterns of exclusion. Funding for initiatives promoting racial equity has been severely restricted, limiting their ability to function and fulfill missions related to racial diversity, equity, or inclusion. More broadly, there is an effort to clamp down on government officials talking about race. For example, the Department of War announced "new restrictions on content," attempting to end editorial independence the newspaper *Stars and Stripes* in order to "refocus its content away from woke distractions" [@Aspan2026]. These initiatives were largely aligned with the language and goals of the Heritage Foundation’s Project 2025, which outlined policies designed to reduce attention to racial inequity in the work of federal government institutions.

<!--Aligned with the mission of reducing attention to racial inequality, Project 2025 recommends using various levers of government power over private actors from talking about race or perusing racial diversity, equity, or inclusion in their organizations. To control nongovernmental organizations in this way requires that the government talk about race as a forbiden topic. --> 

In other ways, attention to race increased under the Trump administration. Departing from the longstanding practice of law enforcement denying accusations of racial profiling, the administration defended racial profiling as legal if related to immigrant capture and removal operations [@Savage2025profiling]. <!--NEW PARAGRAPH: "In yet other ways, attention to race has changed substantive direction...-->  At the same time, the US State Department and US Citizenship and Immigration Services (USCIS) justified prioritizing White South Africans because they allegedly face racial discrimination [@USMissionSouthAfrica2025]. Likewise, the Equal Employment Opportunity Commission (EEOC) invested resources in encouraging White Americans to bring claims of reverse discrimination [@Savage2025employment]. The EEOC also reclassified employer efforts to prevent discrimination and create inclusive workplaces as discrimination against White men [@VinsonElkins2025]. While some goverment attention to directly addresses White genocide or white culture, most uses racial coded language such as "heratige americans," "anti-woke" 
...
We show that racialization is distinct from political ideology. Agencies discussed in racialized language are perceived as further from the political center. However, among the sources, this relationship is only statistically significant (p < 0.05) in the Project 2025 Mandate for Leadership text.
...
Race has long shaped American public policy, yet we know surprisingly little about when race becomes visible within the everyday discourse surrounding federal agencies. Scholars have documented racial inequalities in policy outcomes and examined representation within government institutions.<!--CITE-->  Far less attention has been paid to how race enters policy debates surrounding the administrative state. At times, federal agencies become focal points of racialized political conflict, such as debates over affirmative action, immigration enforcement, civil rights protections, environmental justice, or diversity initiatives. At other moments, race appears largely absent from discussions of government activity, even as agencies advance or retrench these same policies. These shifts raise an important question: when and why do federal agencies become embedded in racial politics?
...
Alien registration numbers refer to non-citizens, but not alwasy in a particularly racialized way, for example FMC: 
