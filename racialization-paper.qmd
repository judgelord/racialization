...
We further aggregate all articles from 2005 to 2025 to create a measure of racialization. We measure the share of articles using racial terms by dividing the number of articles mentioning each agency with racialized words by the total number of articles mentioning each agency.^
An alternative approach, measuring the volume of racialized attention, would use only the count of the number of articles mentioning racialized words as shown in @fig-nyt-data. We show results with this alternative measure in the supplementary replication materials.] 
...
knitr::include_graphics("docs/figs/trends-rule-docs-racial-1.png") # racial 
knitr::include_graphics("docs/figs/trends-rule-docs-racial-2.png") # racial 
knitr::include_graphics("docs/figs/trends-rule-docs-racial-1.png") # racial 
knitr::include_graphics("docs/figs/trends-rule-docs-civil-rights-1.png") #affirmative action 
# knitr::include_graphics("docs/figs/trends-rule-docs-term-33.png") # communitis of color
knitr::include_graphics("docs/figs/trends-rule-docs-term-36.png") # 
knitr::include_graphics("docs/figs/trends-rule-docs-term-55.png") # ethnic
knitr::include_graphics("docs/figs/trends-rule-docs-term-49.png") # DEI
knitr::include_graphics("docs/figs/trends-rule-docs-term-90.png") # minority pop
#knitr::include_graphics("docs/figs/trends-rule-docs-groups-1.png") # ethnicity 
knitr::include_graphics("docs/figs/trends-rule-docs-groups-10.png") # Muslim 
knitr::include_graphics("docs/figs/trends-rule-docs-groups-2.png") # asian
knitr::include_graphics("docs/figs/trends-rule-docs-groups-5.png") # african american 
knitr::include_graphics("docs/figs/trends-rule-docs-groups-6.png") # hispanic
```
